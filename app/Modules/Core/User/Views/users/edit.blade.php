                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-8">
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-lg-6">
                                            <x-form.input.base name="name" label="Full Name"
                                                placeholder="Enter full name" :value="$user->name" icon="ki-outline ki-user"
                                                size="lg" :required="true" />
                                        </div>
                                        <div class="col-lg-6">
                                            <x-form.input.base name="email" type="email" label="Email Address"
                                                placeholder="Enter email address" :value="$user->email" icon="ki-outline ki-sms"
                                                size="lg" :required="true" />
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <div class="col-lg-6">
                                            <x-form.input.base name="phone" type="tel" label="Phone Number"
                                                placeholder="+1 555-0100" :value="$user->phone ?? ''" icon="ki-outline ki-phone"
                                                size="lg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-lg-6 mb-3 mb-lg-0">
                                            <x-form.input.base name="password" type="password" label="New Password"
                                                placeholder="Enter new password" icon="ki-outline ki-lock" size="lg"
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    @php
                                        $userModuleIds = isset($user->modules)
                                            ? collect($user->modules)->pluck('id')
                                            : collect();
                                    @endphp
                                    <div class="row g-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-4 pt-4 border-top">
                                        ...
                                        <span class="badge badge-light-primary fs-7"
                                            id="selectedModuleCount">{{ $userModuleIds->count() }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-footer border-0 pt-0">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex justify-content-between py-3 border-bottom">
                                            ...
                                            <span
                                                class="fw-semibold fs-7">{{ $user->created_at ? $user->created_at->format('M d, Y') : 'N/A' }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between py-3">
                                            <span class="text-muted fs-7">Last Login</span>
                                            <span
                                                class="fw-semibold fs-7">{{ $user->last_login_at ? $user->last_login_at->diffForHumans() : 'Never' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-flush">
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-3">
                                        ...
                                        <a href="{{ route('user.users.permissions', $user->id) }}"
                                        ...
                                        <a href="{{ route('user.users.restrictions', $user->id) }}"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Listen for new role creation from modal
            document.addEventListener('roleCreated', function(e) {
                const role = e.detail;
                const rolesContainer = document.getElementById('rolesContainer');

                // Create new role radio option
                const roleHtml = `
            <div class="col-md-6">
                <label class="d-flex flex-stack cursor-pointer">
                    <span class="d-flex align-items-center me-2">
        ...
        `;
                ...
                // Attach role change listener to new radio
                const newRadio = rolesContainer.querySelector(`input[value="${role.id}"]`);
                if (newRadio) {
