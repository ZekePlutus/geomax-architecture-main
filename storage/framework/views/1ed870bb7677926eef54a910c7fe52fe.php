<div id="kt_app_sidebar" class="app-sidebar" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-primary">
                ...
                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                    ...
                    <div class="menu-sub menu-sub-dropdown px-2 py-4 w-200px w-lg-225px mh-75 overflow-auto">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link"
                                href="https://preview.keenthemes.com/metronic8/demo50/layout-builder.html"
        ...
        <div class="d-flex flex-column flex-center pb-4 pb-lg-8" id="kt_app_sidebar_footer">
            <!--begin::User menu-->
            <div class="cursor-pointer symbol symbol-40px mb-9"
                data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-attach="parent"
                data-kt-menu-placement="right-end">
                <img src="/assets/media/avatars/300-2.jpg" alt="user" />
            </div>
            <!--begin::User account menu-->
           <?php echo $__env->make('includes.profile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="app-sidebar-secondary">
        ...
        <div class="menu menu-sub-indention menu-rounded menu-column fw-semibold fs-6 py-4 py-lg-6"
            ...
            <div id="kt_app_sidebar_secondary_menu_wrapper" class="hover-scroll-y mx-3 px-4" data-kt-scroll="true"
...
<?php /**PATH /home/anass/public_html/resources/views/layout50/sidebar/index.blade.php ENDPATH**/ ?>