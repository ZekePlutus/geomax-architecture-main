<?php $__env->startSection('title', 'Component Examples'); ?>
...
<div class="row g-5 g-xl-10 mt-5">
    ...
    <div class="col-md-4 col-lg-3">
        <a href="<?php echo e(route('examples.form.input')); ?>" class="card card-flush h-100 hover-elevate-up">
...
<div class="row g-5 g-xl-10 mt-5">
    ...
    <!--begin::Col - Drawer -->
    <div class="col-md-4 col-lg-3">
        <a href="<?php echo e(route('examples.drawer')); ?>" class="card card-flush h-100 hover-elevate-up">
            <div class="card-body d-flex flex-column align-items-center justify-content-center py-10">
...
<div class="row g-5 g-xl-10 mt-5">
    ...
    <!--begin::Col - DataTable -->
    <div class="col-md-4 col-lg-3">
        <a href="<?php echo e(url('/examples/datatable')); ?>" class="card card-flush h-100 bg-hover-light-primary border border-hover-primary">
            <div class="card-body d-flex flex-column align-items-center justify-content-center py-10">
                <div class="symbol symbol-60px symbol-circle mb-5 bg-light-primary">
                    <span class="symbol-label">
...
<?php echo $__env->make('layout50.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/anass/public_html/resources/views/layout50/examples/index.blade.php ENDPATH**/ ?>